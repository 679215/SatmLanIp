...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        ListenPortEntry.SettingChanged += (_, __) => ListenPort = NormalizePortEntry(ListenPortEntry);
        JoinAddressEntry.SettingChanged += (_, __) => JoinAddress = JoinAddressEntry.Value ?? "";
        JoinPortEntry.SettingChanged += (_, __) => JoinPort = NormalizePortEntry(JoinPortEntry);
